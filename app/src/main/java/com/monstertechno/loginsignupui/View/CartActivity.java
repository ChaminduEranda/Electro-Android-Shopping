package com.monstertechno.loginsignupui.View;

import static com.monstertechno.loginsignupui.Adapter.ProductAdapter.cartModels;
...
import com.monstertechno.loginsignupui.Adapter.CartAdapter;
import com.monstertechno.loginsignupui.MainActivity1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity1.cart_count = (temparraylist.size());
//                addItemInCart.clear();
                finish();
            }
        });
        MainActivity1.cart_count = 0;
